<%@ Page Title="" Language="C#" MasterPageFile="~/views/Site1.Master" AutoEventWireup="true" CodeBehind="history.aspx.cs" Inherits="WebApplication3.views.history" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <h1 style="color:#ff0000"> Donors History</h1>
        ...
        <div style="width:25%;float:left;color:#ac9696; font-family:'Arial Rounded MT' ">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td style="width: 110px">Bottle no</td>
                    <td><asp:Label ID="Label2" runat="server" Text='<%# Eval("b_no")%>'></asp:Label></td>
