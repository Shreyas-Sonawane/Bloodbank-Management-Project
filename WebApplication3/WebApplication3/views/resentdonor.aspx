<%@ Page Title="" Language="C#" MasterPageFile="~/views/Site1.Master" AutoEventWireup="true" CodeBehind="resentdonor.aspx.cs" Inherits="WebApplication3.views.resentdonor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <img src="02.jpg" style="height:250px;width:100%" />

   
    <div style="margin:0 auto;min-height:1000px; overflow:scroll">
    <h1 style="color:#ff0000"> <marquee direction="right">All Donors</marquee></h1>
