...
namespace WebApplication3.views
{
    public partial class viewprofile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string q = "select d_id,d_name,d_cnic,d_email,d_contact,d_age,B.B_NAME from user_donor d  JOIN  bloodgroup B ON B.b_id=d_blood where d.d_id="  +HiddenField1.Value;
