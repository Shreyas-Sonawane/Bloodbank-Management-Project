...
namespace WebApplication3.views
{
    public partial class profile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (Session["u_id"] != null)
                {
                    ...
                    string q = "select d_id,d_name,d_cnic,d_email,d_contact,d_age,B.B_NAME,d_hb,d_sex from user_donor d JOIN  bloodgroup B ON B.b_id=d_blood where d.d_id=" + Session["u_id"];
        ...
        {
            Response.Redirect("~/views/update.aspx");
        }
    }
}