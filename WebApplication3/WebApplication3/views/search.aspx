...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="background-color:#e2caca;width:100%;height:150px;">
        ...
        <div>
      <span>  Blood Group:     <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="b_name" DataValueField="b_id" Height="35px" Width="69px"></asp:DropDownList>
