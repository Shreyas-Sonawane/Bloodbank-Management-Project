    ...
    public class insert
    {
        ...
        public string insert_donor(donors d)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@d_hb", SqlDbType.NVarChar, 50).Value = d.d_hb;
                cmd.Parameters.Add("@d_sex", SqlDbType.NVarChar, 6).Value = d.d_sex;
                cmd.Parameters.Add("@d_status", SqlDbType.NVarChar, 5).Value = d.d_status;
